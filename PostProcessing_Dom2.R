...
plotHist <- function(feature)
{
     breaks=c(-1000, seq(-4,4,0.5), 1000)
     wt <- shinyData[Class == 'WT']$Stats.Moment3AboutMean_WholeCell_485X525_minus_648X684
     mt <- shinyData[Class == 'MT']$Stats.Moment3AboutMean_WholeCell_485X525_minus_648X684
     cmt <- rgb(0,0,1,0.8)
     cwt <- rgb(1,0,0,0.8)
